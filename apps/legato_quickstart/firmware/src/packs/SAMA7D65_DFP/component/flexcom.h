...
#define   FLEX_SPI_CR_REQCLR_0_Val            _UINT32_(0x0)                                        /* (FLEX_SPI_CR) No effect.  */
#define   FLEX_SPI_CR_REQCLR_1_Val            _UINT32_(0x1)                                        /* (FLEX_SPI_CR) Clears the potential clock request currently issued by SPI, thus the potential system wake-up is cancelled.  */
#define   FLEX_SPI_CR_REQCLR_1_Val            _UINT32_(0x1)                                        /* (FLEX_SPI_CR) Restarts the comparison trigger to enable FLEX_SPI_RDR loading.  */
#define FLEX_SPI_CR_REQCLR_0                  (FLEX_SPI_CR_REQCLR_0_Val << FLEX_SPI_CR_REQCLR_Pos) /* (FLEX_SPI_CR) No effect. Position  */
#define FLEX_SPI_CR_REQCLR_0                  (FLEX_SPI_CR_REQCLR_0_Val << FLEX_SPI_CR_REQCLR_Pos) /* (FLEX_SPI_CR) No effect. Position  */
#define FLEX_SPI_CR_REQCLR_1                  (FLEX_SPI_CR_REQCLR_1_Val << FLEX_SPI_CR_REQCLR_Pos) /* (FLEX_SPI_CR) Clears the potential clock request currently issued by SPI, thus the potential system wake-up is cancelled. Position  */
