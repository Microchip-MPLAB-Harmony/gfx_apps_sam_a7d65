...
{"0": {
    ...
    "url": "http://localhost:4000/gfx_apps_sam_a7d65/mplab_harmony_license.html",
    "relUrl": "/mplab_harmony_license.html"
  },"1": {
    "doc": "Example Applications",
    "title": "Example Applications",
    "content": "The following applications are provided to demonstrate both basic and advanced Graphics capabilities of the SAM A7D65 Family. ",
    "url": "http://localhost:4000/gfx_apps_sam_a7d65/apps/readme.html",
    "relUrl": "/apps/readme.html"
  },"2": {
    "doc": "Example Applications",
    "title": "Legato Library Examples",
    "content": ". | Legato Quickstart | . This demonstration provides a touch-enabled starting point for the legato graphics library. ",
    "url": "http://localhost:4000/gfx_apps_sam_a7d65/apps/readme.html#legato-library-examples",
    "relUrl": "/apps/readme.html#legato-library-examples"
  },"3": {
    "doc": "Legato Quickstart",
    "title": "Legato Quickstart",
    "content": ". This demonstration provides a touch-enabled starting point for the legato graphics library. | MPLABX Configuration | Board Configuration | . | legato_qs_a7d65_curiosity_ac69t88a.X | SAMA7D65 Curiosity using XLCDC internal graphics controller to drive the AC69T88A LVDS WVGA Display | . | legato_qs_a7d65_curiosity_ws_7_9inch.X | SAMA7D65 Curiosity using XLCDC internal graphics controller to drive the Waveshare 7.9inch DSI LCD Display Note: Please contact your local Microchip Sales Office for access to the MIPI DSI 34 to 15 pin adapter! | . ",
    "url": "http://localhost:4000/gfx_apps_sam_a7d65/apps/legato_quickstart/readme.html",
    "relUrl": "/apps/legato_quickstart/readme.html"
  },"4": {
    "doc": "Release notes",
    "title": "Release notes",
    "content": "![Microchip Graphics Suite](https://mchpgfx.github.io/legato.docs/docs/legato/images/mgs.svg) Microchip Graphics Suite Harmony Application Examples for SAM A7D65 Family ## Microchip Graphics Suite Harmony Application Examples for SAM A7D65 Family v1.0.0 ### Development kit and demo application support Following table provides number of peripheral library examples available for different development kits. | Development Kits | MPLABx applications |:-----------------|:-------------------:| SAM A7D65 Curiosity | 2 | ## Release v1.0.0 ### New Features New features added in this release are as follows: - Added Legato Quickstart WVGA configuration for the [AC69T88A LVDS WVGA Display](https://www.microchipdirect.com/dev-tools/AC69T88A?allDevTools=true) - Added Legato Quickstart 1280x400 configuration for the [Waveshare 7.9inch DSI LCD](https://www.waveshare.com/7.9inch-dsi-lcd.htm) Display ### Known Issues No Known Issues ### Development Tools - [MPLAB® X IDE v6.20](https://www.microchip.com/mplab/mplab-x-ide) - [MPLAB® XC32 C/C++ Compiler v4.35](https://www.microchip.com/mplab/compilers) - MPLAB® X IDE plug-ins: - MPLAB® Code Configurator (MCC) Plugin v5.5.1 ### Dependent Components * [GFX v3.15.1](https://github.com/Microchip-MPLAB-Harmony/gfx/releases/tag/v3.15.1) ",
    "url": "http://localhost:4000/gfx_apps_sam_a7d65/release_notes.html",
    "relUrl": "/release_notes.html"
  },"5": {
    "doc": "Microchip Graphics Suite Harmony SAM A7D65 Applications Package",
    "title": "Microchip Graphics Suite Harmony SAM A7D65 Applications Package",
    "content": "# ![Microchip Graphics Suite](https://mchpgfx.github.io/legato.docs/docs/legato/images/mgs.svg) Microchip Graphics Suite Harmony Application Examples for SAM A7D65 Family Microchip Graphics Suite Harmony is an extension of the MPLAB® ecosystem for creating embedded firmware solutions for Microchip 32-bit SAM and PIC® microcontroller and microprocessor devices. Refer to the following links for more information: - [Microchip 32-bit MCUs](https://www.microchip.com/design-centers/32-bit) - [Microchip 32-bit MPUs](https://www.microchip.com/design-centers/32-bit-mpus) - [Microchip MPLAB® X IDE](https://www.microchip.com/mplab/mplab-x-ide) - [Microchip MPLAB® Harmony](https://www.microchip.com/mplab/mplab-harmony) - [Microchip MPLAB® Harmony Pages](https://microchip-mplab-harmony.github.io/) - [MPLAB® Discover](https://mplab-discover.microchip.com/v2?dsl=Microchip+AND+Graphics+AND+Suite) This repository contains the Microchip Graphics Suite Harmony application examples for SAM A7D65 Family. Graphics applications are standalone applications which demonstrate of some of the capabilities of Microchip Graphics Suite Harmony. Refer to the following links for release notes, home page, training materials, framework and application help. For more information on the tools, libraries and basic development with the Microchip Graphics Suite, please see the gfx repo also on github. - [Release Notes](/gfx_apps_sam_a7d65/release_notes.html) - [MPLAB® Harmony License](/gfx_apps_sam_a7d65/mplab_harmony_license.html) - [User Guides on Microchip Graphics Suite Harmony](https://developerhelp.microchip.com/xwiki/bin/view/software-tools/mgs/mgs-harmony-guide/) - [Information on Microchip Graphics Suite Development Kits](https://developerhelp.microchip.com/xwiki/bin/view/software-tools/mgs/dev-kits/) # Contents Summary | Folder | Description |------------|----------------------------------------------| apps | Example Graphics applications | docs | Contains documentation in html format | Documentation is available for offline viewing. It can be used only after cloning this repository onto a local machine. For online viewing, please use [github pages](https://microchip-mplab-harmony.github.io/gfx_apps_sam_a7d65/) of this repository. ## Graphics application examples (Legato) The following applications are provided to demonstrate a subset of the capabilities of Harmony Graphics Suite. | Category | Item | Description | Release Type | --- | --- | ---- |---- | apps | [legato_quickstart](/gfx_apps_sam_a7d65/apps/legato_quickstart/readme.html) | Legato Graphics Library Quickstart Example | ![app-beta](https://img.shields.io/badge/application-beta-orange?style=plastic) | ____ [![License](https://img.shields.io/badge/license-Harmony%20license-orange.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_sam_a7d65/blob/master/mplab_harmony_license.md) [![Latest release](https://img.shields.io/github/release/mchpgfx/legato.docs.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx/tree/v3.15.0) [![Latest release date](https://img.shields.io/github/release-date/mchpgfx/legato.docs.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx/tree/v3.15.0) [![Commit activity](https://img.shields.io/github/commit-activity/y/Microchip-MPLAB-Harmony/gfx_apps_sam_a7d65.svg)](https://github.com/Microchip-MPLAB-Harmony/gfx_apps_sam_a7d65/graphs/commit-activity) [![Contributors](https://img.shields.io/github/contributors-anon/Microchip-MPLAB-Harmony/gfx_apps_sam_a7d65.svg)]() ____ [![Follow us on Youtube](https://img.shields.io/badge/Youtube-Follow%20us%20on%20Youtube-red.svg)](https://www.youtube.com/user/MicrochipTechnology) [![Follow us on LinkedIn](https://img.shields.io/badge/LinkedIn-Follow%20us%20on%20LinkedIn-blue.svg)](https://www.linkedin.com/company/microchip-technology) [![Follow us on Facebook](https://img.shields.io/badge/Facebook-Follow%20us%20on%20Facebook-blue.svg)](https://www.facebook.com/microchiptechnology/) [![Follow us on Twitter](https://img.shields.io/twitter/follow/MicrochipTech.svg?style=social)](https://twitter.com/MicrochipTech) [![](https://img.shields.io/github/stars/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() [![](https://img.shields.io/github/watchers/Microchip-MPLAB-Harmony/gfx.svg?style=social)]() ",
    "url": "http://localhost:4000/gfx_apps_sam_a7d65/",
    "relUrl": "/"
  }
}
`;
...
var repo_name = "gfx_apps_sam_a7d65";
var doc_folder_name = "docs";
var localhost_path = "http://localhost:4000/";
var home_index_string = "Microchip Graphics Suite Harmony SAM A7D65 Applications";
...
jtd.setTheme = function(theme) {
  ...
  cssFile.setAttribute('href', 'http://localhost:4000/gfx_apps_sam_a7d65/assets/css/just-the-docs-' + theme + '.css');
}
